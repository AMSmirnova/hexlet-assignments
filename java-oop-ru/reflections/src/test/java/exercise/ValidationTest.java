...
//    }
    ...
    void testAdvancedValidate() {
        ...
        List<String> notNull = List.of("can not be null");
        List<String> wrongLength = List.of("length less than 3");

        Address address2 = new Address(null, "London", "1-st street", "5", "1");
        Map<String, List<String>> result2 = Validator.advancedValidate(address2);
        Map<String, List<String>> expected2 = Map.of("country", notNull);
        assertThat(result2).isEqualTo(expected2);

        Address address3 = new Address("Ru", null, null, null, "1");
        Map<String, List<String>> result3 = Validator.advancedValidate(address3);
        Map<String, List<String>> expected3 = Map.of("country", wrongLength, "city", notNull, "street", notNull,"houseNumber", notNull);
        assertThat(result3).isEqualTo(expected3);
    }
    // END
}
